...
if __name__ == "__main__":
    ...
    ni = News()
    ni_category = 'national'
    body = ni.fetch_bhaskar_news(category= ni_category)
    mail_instance = EmailWithPython(config_path=config_path,text_file=False, is_html=True)
    mail_instance.send_email(rec_email=send_to,subject= f'Dainik Bhaskar | {ni_category.title()}', body = body)
